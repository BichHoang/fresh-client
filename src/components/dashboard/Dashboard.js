                                            ...
                                            <div className="table-responsive">
                                                <table className="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <img src="assets/images/faces/face1.jpg" className="mr-2" alt="hinh anh" /> David Grey </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="assets/images/faces/face2.jpg" className="mr-2" alt="hinh anh" /> Stella Johnson </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="assets/images/faces/face3.jpg" className="mr-2" alt="hinh anh" /> Marina Michel </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img src="assets/images/faces/face4.jpg" className="mr-2" alt="vc" /> John Doe </td>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="row mt-3">
                                                <div className="col-6 pr-1">
                                                    <img src="assets/images/dashboard/img_1.jpg" className="mb-2 mw-100 w-100 rounded" alt="hinh anh" />
                                                    <img src="assets/images/dashboard/img_4.jpg" className="mw-100 w-100 rounded" alt="hinh anh" />
                                                </div>
                                                <div className="col-6 pl-1">
                                                    <img src="assets/images/dashboard/img_2.jpg" className="mb-2 mw-100 w-100 rounded" alt="hinh anh" />
                                                    <img src="assets/images/dashboard/img_3.jpg" className="mw-100 w-100 rounded" alt="hinh anh" />
                                                </div>
                                            </div>
                                            <div className="d-flex mt-5 align-items-top">
                                                <img src="assets/images/faces/face3.jpg" className="img-sm rounded-circle mr-3" alt="hinh anh" />
